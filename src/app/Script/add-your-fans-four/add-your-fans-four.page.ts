...
@Component({
	selector: "app-add-your-fans-four",
	templateUrl: "./add-your-fans-four.page.html",
	styleUrls: ["./add-your-fans-four.page.scss"],
})
export class AddYourFansFourPage implements OnInit {
	form: FormGroup;
	relationships;
	salutation: string = "";
	relationship = "Coaches, Teachers & Mentors";
			...
			buttons: [
				{
					text: "NO",
					handler: () => {
						this.router.navigateByUrl("/script/add-your-fans-five");
					},
				},
				{
					text: "YES",
