...
@Component({
	selector: "app-add-your-fans-two",
	templateUrl: "./add-your-fans-two.page.html",
	styleUrls: ["./add-your-fans-two.page.scss"],
})
export class AddYourFansTwoPage implements OnInit {
	form: FormGroup;
	relationships;
	salutation: string = "";
	relationship = "Aunts, Uncles, Cousins, & Adult Sibilings";
	...
	constructor(
		...
		this.relationships = this.relationshipService.getRuleTwoRelationships();
	}
	...
	getSalutation() {
		...
		// this.salutation = this.salutationService.getSaluation(relationshipText, firstName, lastName);
	}
			...
			buttons: [
				{
					text: "NO",
					handler: () => {
						this.router.navigateByUrl("/script/add-your-fans-three");
					},
				},
				{
					text: "YES",
