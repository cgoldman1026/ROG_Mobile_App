...
@Component({
	selector: "app-add-your-fans-one",
	templateUrl: "./add-your-fans-one.page.html",
	styleUrls: ["./add-your-fans-one.page.scss"],
})
export class AddYourFansOnePage implements OnInit {
	form: FormGroup;
	relationships;
	salutation: string = "";
	...
	constructor(
		...
		this.relationships = this.relationshipService.getRuleOneRelationships();
	}
			...
			buttons: [
				{
					text: "NO",
					handler: () => {
						this.router.navigateByUrl("/script/add-your-fans-two");
					},
				},
				{
					text: "YES",
