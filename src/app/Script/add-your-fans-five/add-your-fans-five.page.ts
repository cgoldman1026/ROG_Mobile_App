...
@Component({
  selector: 'app-add-your-fans-five',
  templateUrl: './add-your-fans-five.page.html',
  styleUrls: ['./add-your-fans-five.page.scss'],
})
export class AddYourFansFivePage implements OnInit {
  form: FormGroup;
	relationships;
	salutation: string = "";
	...
	constructor(
		...
		this.relationships = this.relationshipService.getRuleFourRelationships();
	}
	...
	updateSalutation() {
		...
		if (relationshipText && firstName && lastName) {
			...
			this.form.get('fanSalutation').setValue(this.salutation);
		}
	...
	async presentFanAddedAlert(firstName, lastName) {
		const alert = await this.alertController.create({
			header: "Fan Added!",
			message: `${firstName} ${lastName} was added to your campaign! Can you add anyone else?`,
			buttons: [
				{
					text: "NO",
					handler: () => {
						this.router.navigateByUrl("/script/share-campaign");
					},
				},
				{
					text: "YES",
